...
export const useVrcxStore = defineStore('Vrcx', () => {
    ...
    async function updateDatabaseVersion() {
        ...
        if (state.databaseVersion < databaseVersion) {
            ...
            try {
                // upgradeDatabaseVersion() creates the missing tables first via
                // initTables(), then runs the data fixes; running the fixes here
                // beforehand breaks the migration on a fresh database
